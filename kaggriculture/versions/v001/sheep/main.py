...
def sale_orders(state, params, shed, reserve_wheat=0):
    ...
    available = {item: max(0, amount - (reserve_wheat if item == 'WHEAT' else 0)) for item, amount in shed.items() if item in CURVES and amount > 0}
    counts = {}
...
PARAMETERS = {'animal_target': 6, 'animal_type': 'SHEEP', 'max_hands': 9}
